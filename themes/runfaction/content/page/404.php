        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="text-center mb-5">
                    ...
                    <h4 class="text-uppercase">Désolé, le page que vous demandez n'existe pas !</h4>
                    <div class="mt-5 text-center">
                        <a class="btn btn-primary waves-effect waves-light" href="<?php echo ''.BASEPATH.'';?>">Retour à l'envoyeur</a>
                    </div>
                </div>
            </div>
        </div>
