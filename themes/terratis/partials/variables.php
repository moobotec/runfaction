...
echo '<script> var pathnameCelios = "'.$param_racine.'";</script>';
echo '<script> var environnementCelios = "'.$param_environement.'";</script>';
echo '<script> var baseCelios = "'.$param_bdd.'";</script>';
echo '<script> var versionCelios = "'.$param_version.'";</script>';
