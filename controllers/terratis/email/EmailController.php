...
class EmailController extends AbstractModelEmail
{
    ...
    {
        $this->title = 'Bienvenue sur Terratis !';
        ...
        if ($password != "")
        {
            ...
            il n\'est pas recommand&#233; d\'utiliser ce mot passe pour vous authentifier sur Terratis.';
        }
        $this->subject = 'Inscription sur Terratis';
