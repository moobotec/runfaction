...
class EmailController extends AbstractModelEmail
{
    ...
    {
        $this->title = 'Bienvenue sur TimeCapsule !';
        ...
        if ($password != "")
        {
            ...
            il n\'est pas recommand&#233; d\'utiliser ce mot passe pour vous authentifier sur TimeCapsule.';
        }
        $this->subject = 'Inscription sur TimeCapsule';
        self::send($email,'Terratis.fr');
    }
    ...
    public function sendResetPasswordByEmail($email,$iduuid,$codereset)
    {
        ...
        $this->send($email,'TimeCapsule.fr');
    }
}
